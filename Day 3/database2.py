...
def connect_db():
    try:
        connection = pymysql.Connect(host='localhost', port=3306, user='root', password='root', database='sam_173_db', charset='utf8')
        print('DB connected')
        return connection
    except:
...
def create_db():
    ...
    query = 'create database IF NOT EXISTS sam_173_db;'
